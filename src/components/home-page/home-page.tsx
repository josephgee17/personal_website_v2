        ...
        <div className={styles.homePageBlock}>
          ...
          <div className={styles.rightSideBlock} style={{ marginTop: 0 }}>
            <h4>
              ...
              skills and reinforce what I&quot;ve learned at work and school. In the
              future, I want to get my masters in computer science. Maybe even
              teach? Who knows
              <br />
              <br />
              For now, here&quot;s some more filler text: Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Ad velit suscipit dolor est,
              laudantium sit iste minima voluptatum fuga ipsam ut voluptas
              fugit, earum qui consectetur possimus quidem doloribus nam.
            </h4>
          </div>
        </div>
            ...
            <div className={styles.blocktextPictureContainer}>
              <div className={styles.subtextPictureContainer}>
                ...
                <h4 style={{ backgroundColor: "inherit" }}>
                  ...
                  deserunt sequi magni illum ut nihil sint! Lorem ipsum dolor
                  sit, amet consectetur adipisicing elit. Aliquam, sed! Maiores
                  consequuntur, dolores fugiat consequatur dignissimos rem
                  quidem eaque voluptas. Dolorum nemo ipsam deserunt sequi magni
                  illum ut nihil sint! Lorem ipsum dolor sit, amet consectetur
                  adipisicing elit. Aliquam, sed! Maiores consequuntur, dolores
                  fugiat consequatur dignissimos rem quidem eaque voluptas.
                  Dolorum nemo ipsam deserunt sequi magni illum ut nihil sint!
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Aliquam, sed! Maiores consequuntur, dolores fugiat consequatur
                  dignissimos rem quidem eaque voluptas. Dolorum nemo ipsam
                  deserunt sequi magni illum ut nihil sint!
                </h4>
                <Button className={styles.appButton} variant="outline-primary">
                  Primary
                </Button>{" "}
